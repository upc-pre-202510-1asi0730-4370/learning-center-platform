...
namespace ACME.LearningCenterPlatform.API.Publishing.Infrastructure.Persistence.EFC.Configutarion.Extensions;
...
public static class ModelBuilderExtensions
{
    ...
    public static void ApplyPublishingConfiguration(this ModelBuilder builder)
    {
        ...
        builder.Entity<Tutorial>().Property(t => t.Summary).IsRequired().HasMaxLength(255);
